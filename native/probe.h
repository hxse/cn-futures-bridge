...
#include <windows.h>
#include <stdint.h>
#define PROBE_MAP L"Local\\CNFB_Terminal_20260923_2"
#define PROBE_MESSAGE L"CNFB_Terminal_20260923_2"
#define PROBE_MAGIC 0x434e4642u
enum { INSPECT=1, EXPORT=2, ARM=3, COUNTS=4, STOP=5, IMPORT=6, SESSION=7, PRODUCT=8, INSTRUMENT=9, SELECT_ROW=10, WINDOWS=11, FOCUS=12, SET_TEXT=13, SELECT_COMBO=14, STARTUP_DONE=15, MANAGED_WINDOWS=16 };
typedef struct {
